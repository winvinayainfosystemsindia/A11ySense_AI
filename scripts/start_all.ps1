...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "allure serve $scriptPath\..\backend/storage/reports/allure-results" -WindowStyle Normal
